...
public class BookDatabase {
     ...
     * TAG for debugging
     */
    public static final String TAG = "BookDatabase3";
     ...
     * database name
     */
    public static String DATABASE_NAME = "book4.db";

    /**
     * table name for BOOK_INFO
     */
    public static String TABLE_BOOK_INFO = "BOOK_INFO4";
    ...
    public ArrayList<UserInfo> selectAll() {
        ...
        try {
            ...
            for (int i = 0; i < cursor.getCount(); i++) {
                ...
                UserInfo info = new UserInfo(name, author, contents);
                result.add(info);
            }
